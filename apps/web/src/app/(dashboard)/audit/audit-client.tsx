  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2 items-end bg-white px-4 py-3 rounded-md border border-neutral-200">
        ...
        {data && (
          <span className="ml-auto text-xs text-neutral-500">{data.total.toLocaleString()} records</span>
        )}
      </div>
                ...
                <tr>
                  <td colSpan={6}>
                    <EmptyState
                      ...
                      body={hasFilters ? 'Try adjusting your filters.' : 'Actions will appear here as they occur.'}
                    />
                  </td>
                </tr>
              ) : (
