...
export function ImportHistory() {
  ...
  const clearMutation = useMutation({
    mutationFn: (batchId: string) => clearInvestmentFlaggedEntries(batchId),
    onSuccess: (updated) => {
      setClearTarget(null);
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        body={`This clears all flagged rows for "${clearTarget?.fileName}". The import stays in history — this does not undo any investments already created.`}
