        ...
        <table width="520" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;border:1px solid #e5e7eb">
          ...
          <tr>
            <td style="padding:28px 32px">
              ...
              <p style="margin:0 0 16px">Your loan (Ref: <span style="font-family: 'JetBrains Mono', 'Consolas', 'SFMono-Regular', monospace;font-weight:bold">${loanRef}</span>) was approved under a short-tenure (&le; 6 months) arrangement at a discounted rate of <strong>10%</strong>. This discount is conditional on full settlement within the agreed tenure.</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 16px;border:1px solid #e5e7eb;border-radius:6px;font-size:13px">
                <tr style="background-color:#f9fafb">
                  ...
                  <td style="padding:8px 12px;text-align:right;font-family: 'JetBrains Mono', 'Consolas', 'SFMono-Regular', monospace">${fmt(originalTotal)}</td>
                </tr>
                <tr>
                  <td style="padding:8px 12px;font-weight:bold;color:#374151">Revised Total Repayable (15%)</td>
                  <td style="padding:8px 12px;text-align:right;font-family: 'JetBrains Mono', 'Consolas', 'SFMono-Regular', monospace">${fmt(revisedTotal)}</td>
                </tr>
                <tr style="background-color:#fef2f2">
                  <td style="padding:8px 12px;font-weight:bold;color:#b91c1c">Additional Amount Reinstated</td>
                  <td style="padding:8px 12px;text-align:right;color:#b91c1c;font-family: 'JetBrains Mono', 'Consolas', 'SFMono-Regular', monospace">${fmt(clawbackAmount)}</td>
                </tr>
                <tr style="border-top:2px solid #e5e7eb">
                  <td style="padding:8px 12px;font-weight:bold">New Outstanding Balance</td>
                  <td style="padding:8px 12px;text-align:right;font-weight:bold;font-family: 'JetBrains Mono', 'Consolas', 'SFMono-Regular', monospace">${fmt(newOutstanding)}</td>
                </tr>
              </table>
